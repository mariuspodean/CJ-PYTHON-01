...
print(stud_collection[3])
print(len(stud_collection))
print(students[0] in stud_collection)
print(students[0] not in stud_collection)

test_student = Student('Lorena', 'Ilas', 29)
print(test_student in stud_collection)
