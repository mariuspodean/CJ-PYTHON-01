...
class TestSquareArea(unittest.TestCase):
    def test_area(self):
        ...
        square = Square(elem, elem, elem, elem)
        self.assertEqual(square.area(), area)

    def test_square_type(self):
        test_homework1 = homework.Polygons(1, 2, 3)
        self.assertIsInstance(test_homework1.sides[0], int)
        self.assertIsInstance(test_homework1.sides[1], int)
        self.assertIsInstance(test_homework1.sides[2], int)
