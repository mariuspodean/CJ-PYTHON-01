...
# recipesbox = RecipesBox(cheesecake, banana_bread, home_made_chocolate, mac_and_cheese)
# recipesbox = RecipesBox(cheesecake)
...
#     print(recipesbox.recipe[i].name)
#
...
fridge = Fridge({'milk': 4, 'potato': 3, 'egg': 2, 'banana': 10, 'sugar': 3, 'macaroni': 2, 'cocoa': 2})
# print(fridge)
# print(fridge.check_ingredient('banana'))
# print(fridge.check_recipe(fries))